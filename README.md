...
Sexto projeto do curso de programação aqui desenvolveremos todos os conceitos aplicados até agora.


## Aprendizados

Nesse projeto irá realizar funções utilizando as Hofs: map, filter, sort, find, forEach e reduce.


## Stack utilizada

**Fundamentais:** Javascript e Jest
...
```bash
  git git@github.com:GuilhermeFMP/Projeto-6-Zoo-Functions.git
  cd Projeto-6-Zoo-Functions
  npm install
```
